...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print XCL address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "xcl",               "masternode",             &masternode,             true,  {} },
    { "xcl",               "masternodelist",         &masternodelist,         true,  {} },
    { "xcl",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "xcl",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "xcl",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "xcl",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

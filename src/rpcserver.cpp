...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* XCL features */
    { "xcl",               "masternode",             &masternode,             true,      true,       false },
    { "xcl",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "xcl",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "xcl",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "xcl",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "xcl",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "xcl",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "xcl",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "xcl",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use xcld, or the -server option to xcl-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> xcl-cli " + methodname + " " + args + "\n";
}

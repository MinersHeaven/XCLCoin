...
/* *** BEGIN DARKSEND MAGIC - XCL **********
    Copyright (c) 2014-2015, XCL Developers
        eduffield - evan@xclcoin.io
        udjinm6   - udjinm6@xclcoin.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat XCL and make it unusable. To

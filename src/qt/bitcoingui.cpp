    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XCL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XCL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xcl: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XCL Core"), this);
    aboutAction->setStatusTip(tr("Show information about XCL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XCL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XCL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XCL addresses"));
    ...
    openAction->setStatusTip(tr("Open a xcl: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XCL Core help message to get a list with possible XCL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("XCL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XCL network", "", count));
}
...
{
    QString strTitle = tr("XCL Core"); // default title

...
RESOURCES += src/qt/xcl.qrc src/qt/xcl_locale.qrc
TRANSLATIONS += src/qt/locale/xcl_bg.ts \
                src/qt/locale/xcl_de.ts \
                src/qt/locale/xcl_en.ts \
                src/qt/locale/xcl_es.ts \
                src/qt/locale/xcl_fi.ts \
                src/qt/locale/xcl_fr.ts \
                src/qt/locale/xcl_it.ts \
                src/qt/locale/xcl_ja.ts \
                src/qt/locale/xcl_pl.ts \
                src/qt/locale/xcl_pt.ts \
                src/qt/locale/xcl_ru.ts \
                src/qt/locale/xcl_sk.ts \
                src/qt/locale/xcl_sv.ts \
                src/qt/locale/xcl_vi.ts \
                src/qt/locale/xcl_zh_CN.ts \
                src/qt/locale/xcl_zh_TW.ts

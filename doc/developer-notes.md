...
However, in open source software such as XCL Core, where everyone uses
...
pay attention to for reviewers of XCL Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: XCL Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against XCL Core so that they can be integrated

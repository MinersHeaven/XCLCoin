...
Only requiring some minor changes is xcl.cpp.
...
Changes to xcl.cpp
----------------------
xcl.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

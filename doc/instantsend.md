...
This mechanism has been integrated into Bitcore-Node-XCL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xclcoin/insight-api-xcl#web-socket-api](https://github.com/xclcoin/insight-api-xcl#web-socket-api)
* API: [https://github.com/xclcoin/insight-api-xcl#instantsend-transactions](https://github.com/xclcoin/insight-api-xcl#instantsend-transactions)
...
By default, the XCL Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XCL Core daemon:

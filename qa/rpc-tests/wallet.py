...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 XCL, node2 has none. 
#   d) node0 sends 21 XCL to node2, in two transactions (11 XCL, then 10 XCL).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 XCL from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 XCL in block rewards plus fees, but
